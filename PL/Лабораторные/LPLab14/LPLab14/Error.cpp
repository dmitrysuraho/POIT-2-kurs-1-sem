...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(114, "Переопределение переменной"),
		ERROR_ENTRY(115, "Функция SUBSTR не определена"),
		ERROR_ENTRY(116, "Функция STRLEN не определена"),
		ERROR_ENTRY(117, "Переменная не определена"),
		ERROR_ENTRY(118, "Функция не определена"),
		...
		ERROR_ENTRY(601, "Ошибка в определении переменных или функций"),
		ERROR_ENTRY(602, "Ошибка в выражении"),
		ERROR_ENTRY(603, "Ошибочный оператор"),
